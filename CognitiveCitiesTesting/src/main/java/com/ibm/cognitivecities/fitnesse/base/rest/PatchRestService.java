...
public class PatchRestService extends RestService {
	
	public PatchRestService(String customHeaders) {
		super(customHeaders);
	}

	public HttpResponse callService(String requestJson, String serviceURL, String username, String password, boolean isSecure)
			throws Exception {
		initParams("PATCH", requestJson, serviceURL, username, password, isSecure);
