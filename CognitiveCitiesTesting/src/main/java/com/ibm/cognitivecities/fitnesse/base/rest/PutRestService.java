...
public class PutRestService extends RestService {
	
	public PutRestService(String customHeaders) {
		super(customHeaders);
	}
	
	public HttpResponse callService(String requestJson, String serviceURL, String username, String password, boolean isSecure)
			throws Exception {
		initParams("PUT", requestJson, serviceURL, username, password, isSecure);
